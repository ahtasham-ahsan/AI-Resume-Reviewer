    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        {!file ? (
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4 sm:gap-8 min-h-[calc(100vh-8rem)] sm:min-h-[calc(100vh-12rem)]">
            {/* PDF Preview */}
            <div className="bg-gray-800 rounded-lg shadow-xl border border-gray-700 flex flex-col h-96 lg:h-auto">
                ...
                {result && (
                  <div className="space-y-6 sm:space-y-8">
                    ...
                    {result.sections?.Skills && (
                      <div>
                        {renderSkills(result.sections.Skills)}
                      </div>
                    )}
                    ...
                    {result.sections?.Experience && (
                      <div>
                        {renderExperience(result.sections.Experience)}
                      </div>
                    )}
                    ...
                    {result.sections?.Education && (
                      <div>
                        {renderEducation(result.sections.Education)}
                      </div>
                    )}
